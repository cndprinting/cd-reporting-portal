    ...
    <section id="rate-card" className="border-b border-line bg-paper-soft">
      <div className="max-w-6xl mx-auto px-6 py-16 lg:py-20">
        ...
        <p className="text-ink-soft mb-8 max-w-2xl">
          ...
          Lock in this rate by <strong>{SALE_END_LONG}</strong>.
        </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cases.map((c) => (
            <Link
              ...
              className="rounded-lg border border-line bg-white p-6 hover:border-brand-300 hover:shadow-sm transition-all group"
            >
              <div className="text-[10px] font-mono uppercase tracking-[0.2em] text-brand-600 mb-2">
                {c.tag}
              </div>
              <h3 className="font-display text-xl font-medium mb-2 group-hover:text-brand-700 transition-colors">
                {c.title}
              </h3>
              <p className="text-sm text-ink-soft leading-relaxed mb-3">
                {c.body}
              </p>
              <div className="text-xs font-medium text-brand-600 group-hover:underline">
                Learn more →
              </div>
            </Link>
          ))}
